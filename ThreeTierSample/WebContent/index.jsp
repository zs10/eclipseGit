...
<body>
	...
	<table border="1px">
		...
		<tr>
			<td><a
				href="QueryStudentBySnoServlet?sno=<%=student.getSno()%>"><%=student.getSno()%></a>
			</td>
	...
	int tPage = p.getTotalPage();
		if (cPage == tPage) { //尾页
	%>
	<a href="QueryStudentByPageServlet?currentPage=1">首页</a>
	<a href="QueryStudentByPageServlet?currentPage=<%=cPage - 1%>    ">上一页</a>
	<%
		}

		else if (cPage == 1) {//首页
	%>
	<a href="QueryStudentByPageServlet?currentPage=<%=cPage + 1%> ">下一页</a>
	<a href="QueryStudentByPageServlet?currentPage=<%=tPage%>">尾页</a>
	<%
		} else {//中间
	%>
	<a href="QueryStudentByPageServlet?currentPage=1">首页</a>
